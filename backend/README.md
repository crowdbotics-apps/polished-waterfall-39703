...
## Project Structure
    ...
    ├── polished_waterfall_39703  # Django project configurations
...
1. Clone this repo and `cd polished_waterfall_39703`
...
2. Clone this repo and `cd polished_waterfall_39703`
